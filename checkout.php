...
<?php
               ...
               $b = 'o';
                ...
                if ($conn->connect_error) {
                    ...
                    for($i=1;$i<=1000;$i++){
                        $query = "SELECT id, product, prize, img FROM cart WHERE (id='$i' && name='$session' && username='$usern')";
                    ...
                    echo "<form action='checkout.php' method='post'>
                                <tr>
                                    ...
                                    <td class='quantity-box'><input type='text' size='' value='' min='' step='' class='c-input-text qty text' name='".$b."q'></td>
                                    
                                    <td class='remove-pr'>
                                    <button type='submit' name = '".$b."'>X</button>
                                    </td>
                                </tr>
                            ...
                            if(isset($_POST[$b])){
                                ...
                                $quer = "DELETE FROM cart WHERE (name='$session' && product ='$b' && username='$usern')";
 ...
 if(isset($_POST['confirm'])){
    ...
    $que = "UPDATE cart SET quantity = '$qw'  WHERE (name='$session' && product ='$b' && username='$usern')";
...
?>
            ...
            <div class='col-12 d-flex shopping-box'><button type='submit' name='confirm' class='btn btn-primary'>Confirm</button> </div> </form>
