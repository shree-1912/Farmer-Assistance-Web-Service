            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>Call US :- <a href="#"> +91 70838 98610</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="order.php">My Orders</a></li>
                ...
                <div class="attr-nav">
                    <ul>
                        ...
                        <li class="">
							<a href="checkout.php">
                            <i class="bi bi-cart4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Mandai</strong></h1>
    ...
    <div class="products-box">
        <div class="container">
            ...
            <div class="row special-list">
                ...
                if ($conn->connect_error) {
                    ...
                    echo "<form action='welcome.php' method='post'><div class='col-lg-3 col-md-6 special-grid best-seller'>
                                <div class='products-single fix'>
                                    <div class='box-img-hover'>

                
                                        <img src='image/".$row['img']."' class='img-fluid' alt='Image' style='height: 200px;'>
                                        <div class='mask-icon'>
                                            <ul>
                                               
                                            </ul>
                                                <button class='btn btn-success' type='submit' name='add".$row['id']."'>Add to Cart</button>
                                                

                                         </div>
                                         </div>
                                    <div class='why-text'>
                                        <h4 name='product'>".$row['name']."</h4>
                                        <h5 name='prize'>₹ ".$row['prize']."\ </h5>
                                        <h5 name='unit'>".$row['unit']."  </h5>
        ...
        if(isset($_POST["add".$row['id'].""])){
            ...
            $img = $row['img'];
                ...
                $q = "INSERT INTO cart(name, username, product, prize, img) VALUE('$session', '$usern', '$item', '$rate', '$img')";
                mysqli_query($conn, $q);
