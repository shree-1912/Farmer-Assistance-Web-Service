    ...
    <div class="products-box">
        <div class="container">
            ...
            <div class="row special-list">
                ...
                $result = mysqli_query($conn, "SELECT * FROM confirmed");
                ...
                if ($conn->connect_error) {
                    ...
                    for($i=1;$i<=1000;$i++){
                        $query = "SELECT id, name, product, prize, img, quantity FROM confirmed WHERE (id= $i && name = '$session' && username ='$usern')";
                    ...
                    echo "<form action='welcome.php' method='post'><div class='col-lg-3 col-md-6 special-grid best-seller'>
                                <div class='products-single fix'>
                                    ...
                                    <div class='why-text'>
                                        <h4 name='product'>".$row['product']."</h4>
                                        <h5 name='prize'>₹ ".$row['prize']."  <br> Quantity:             ".$row['quantity']."</h5>
